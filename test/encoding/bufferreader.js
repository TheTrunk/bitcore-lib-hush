...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10HUSH', function() {
      var tenHUSH = 10 * 1e8;
      var tenHUSHBuffer = new Buffer('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenHUSHBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenHUSH);
    });
