...
/**
 * Retrieve a hexa string that can be used with hushd's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more Hush than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of hushd's `listunspent` command,
 ...
 *
 * // From a pay to public key hash output from hushd's listunspent
...
/**
 * Analogous to hushd's IsCoinBase function in transaction.h
 */
